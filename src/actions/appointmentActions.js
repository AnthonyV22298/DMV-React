...
export const readAppointments = () => {
    ...
    return dispatch => {
        ...
        "https://sstackmay.crm.dynamics.com/api/data/v9.1/dmv_appointments" +
        "?$select=dmv_appointmentid,dmv_app_type,dmv_time,dmv_app_date,_dmv_contactid_value" + 
        "&$filter=dmv_isactive ne 174070001", config)
            .then(res => {
...
export const readDates = () => {
    ...
    return dispatch => {
        ...
        return adalApiFetch(axios, 
        "https://sstackmay.crm.dynamics.com/api/data/v9.1/dmv_appointments" +
        "?$select=dmv_app_date,dmv_time", config)
            .then(res => {
...
export const postAppointments = (data) => {
    ...
    return dispatch => {
        ...
        return adalApiFetch(axios, "https://sstackmay.crm.dynamics.com/api/data/v9.1/dmv_appointments", config)
            .then(res => {
...
export const updateAppointment = (data) =>{
    ...
    return dispatch => {
            ...
            return adalApiFetch(axios, "https://sstackmay.crm.dynamics.com/api/data/v9.1/dmv_appointments("+data.dmv_appointmentid+")?$select=dmv_app_type,dmv_time,_dmv_appointmentlocation_value,dmv_appointment_date", updateConfig)
            .then((res) => {
...
export const cancelAppointment = (guid) =>{
    ...
    return dispatch => {
            ...
            return adalApiFetch(axios, "https://sstackmay.crm.dynamics.com/api/data/v9.1/dmv_appointments("+guid+")?$select=dmv_isactive" , cancelConfig)
            .then((res) => {
