...
class TypeDropdown extends Component {
  ...
  getOptions() {
    ...
    adalApiFetch(axios,"https://sstackmay.crm.dynamics.com/api/data/v8.2/GlobalOptionSetDefinitions(Name='dmv_app_type')/Microsoft.Dynamics.CRM.OptionSetMetadata",config)
        .then(results => {
